...
<html>
    <head>
        ...
        <?php include 'php/database_v2.0.php';
                ...
                <table>
                    <form action="" method="POST">
                        ...
                        if (isset($_POST[$columnNames[0][1]] ) ) {
                            ...
                            $colN = selCollBinary($columnNames[0], "013");
                            $where = createWhere($colN);
                            //print_r($columnNames[0]);

                            //select the columnNames
                            $colN = selCollBinary($columnNames[0], "002");

                            //Generate DataArray
                            $dataArray = generate2dArrayFromDB($tableNames[0], $colN, $where );
